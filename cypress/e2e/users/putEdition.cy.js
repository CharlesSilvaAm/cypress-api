                ...
                cy.getUsers(searchusers, token)
                    .then(response => {
                        ...
                        if (desiredUser) {
                            ...
                            cy.putUser( edituser, `${userId}`, token )
                                .then(userResponse => {
                                    ...
                                    expect(userResponse.body.name).to.equal('Testando-Rest')
